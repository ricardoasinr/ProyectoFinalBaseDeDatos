...
namespace Practica2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //string connString = "Data Source=sa ;Initial Catalog=Practica6mayo;";
            string connString = "Data Source =Macbook-Pro-de-Ricardo; Initial Catalog = BDASIN; Integrated Security=True; TrustServerCertificate=True; User ID = sa; Password = Docker@123";

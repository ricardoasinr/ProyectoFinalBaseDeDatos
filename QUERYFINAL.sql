...
PrecioRIM money not null,
PrecioMO money not null,
PrecioTOT money not null,
PrecioIVA as PrecioTOT+PrecioTOT*0.13,
...
insert into Facturas values ('FR0001', 'H893', 'M001', '8127786', 'Bujia T783', '300', '450', '750')
...
@p_PrecioIVA money
  as
begin
  insert into Facturas values(@p_CodFactura,@p_CodHoja,@p_CodMecanico,@p_CI_Clientes,@p_NombreRIM,@p_PrecioRIM, @p_PrecioMO,@p_PrecioTOT,@p_PrecioIVA )
   --set precioiva = preciotot+preciotot*0.13;
    SELECT Facturas, @p_PrecioTOT, @p_PrecioTOT * 0,13 + @p_PrecioTOT AS @p_PrecioTOT  FROM Facturas.PrecioTOT
...
@p_Manodeobra='500';
    ...
    select * from Clientes WHERE  CI_Clientes = '8127786';

    select * from Mecanicos
    WHERE CodMecanico = 'M002';
...
select * from Mecanicos
update Mecanicos set Disponibilidad = 'Ocupado' where CodMecanico = 'M001'
